...
CREATE TABLE "new_Person" (
    ...
    "formerPlayer" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_Person" ("archived", "archivedAt", "attended", "createdAt", "email", "event1Rsvp", "event2Rsvp", "event3Rsvp", "firstName", "formerRank", "fourSeasons", "game", "id", "industry", "journalist", "lastEditedBy", "lastName", "magician", "mi", "nmCreatorInLA", "notes", "onFormer", "onQuickList", "onVegas", "outOfTown", "phone", "plusOnes", "previousPlayer", "quickRank", "rando", "sent", "staffFamily", "title", "upcomingInviteStatus", "upcomingInvitedOn", "updatedAt", "vegasRank", "whoIsThis") SELECT "archived", "archivedAt", "attended", "createdAt", "email", "event1Rsvp", "event2Rsvp", "event3Rsvp", "firstName", "formerRank", "fourSeasons", "game", "id", "industry", "journalist", "lastEditedBy", "lastName", "magician", "mi", "nmCreatorInLA", "notes", "onFormer", "onQuickList", "onVegas", "outOfTown", "phone", "plusOnes", "previousPlayer", "quickRank", "rando", "sent", "staffFamily", "title", "upcomingInviteStatus", "upcomingInvitedOn", "updatedAt", "vegasRank", "whoIsThis" FROM "Person";
DROP TABLE "Person";
...
CREATE INDEX "Person_archived_idx" ON "Person"("archived");
